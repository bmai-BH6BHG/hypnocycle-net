...
<div id="language-toggle" style="text-align: center; margin-bottom: 20px;">
  <button onclick="showLanguage('zh')" style="padding: 5px 10px; margin: 0 5px; cursor: pointer; background-color: #4CAF50; color: white; border: none; border-radius: 4px;">中文</button>
  <button onclick="showLanguage('en')" style="padding: 5px 10px; margin: 0 5px; cursor: pointer; background-color: #008CBA; color: white; border: none; border-radius: 4px;">English</button>
</div>
